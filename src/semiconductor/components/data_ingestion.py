...
import pandas as pd
from src.semiconductor.entity.config_entity import DataIngestionConfig
from src.semiconductor import CustomException, logger
...
class DataIngestion:
    ...
    def download_file(self):
        ...
        try:
            ...
            query = "SELECT * FROM semiconductor_table"
